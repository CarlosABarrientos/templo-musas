Un archivo README.md es un archivo de texto que describe y explica un proyecto, escrito en el lenguaje de marcado Markdown. Es un recurso común en proyectos de software. 
Características
